...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <figure class="m-0">
            <a href="index.html"><img src="images/Logo_ESSAT_Gabés.png" alt="Image" class="img-fluid"></a>
          </figure>
          <div class="site-logo mr-auto w-25"><a href="index.html"><h5>Ecole Supérieure des Sciences Appliquées et de la Technologie </h5></a></div>
    ...
    <div class="intro-section" id="home-section">
      ...
      <div class="slide-1" style="background-image: url('images/honey-yanibel-minaya-cruz-laORtJZaieU-unsplash.jpg');" data-stellar-background-ratio="0.5">
        <div class="container">
            ...
            <div class="col-12">
              <div class="row align-items-center">
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="verif" method="post" class="form-box">
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/test/honey-yanibel-minaya-cruz-laORtJZaieU-unsplash.jpg');">
      <div class="container">
